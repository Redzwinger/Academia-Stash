...
weight_h_three = np.random.rand(4,1) # New Node

weight_o_one = np.random.rand(3,1)
weight_o_two = np.random.rand(3,1)
weight_o_three = np.random.rand(3,1)

bias_one = np.random.rand(1)
bias_two = np.random.rand(1)

bias_three = np.random.rand(1) # New Bias
...
Z2_3 = np.dot(data_stuf, weight_h_three) + bias_three
...
HiddenLayer_Two = np.append(HiddenLayer_Two, H2_3, axis=1)
